...
class Constants {
    companion object {
        ...
        var HOME_ITEM_NAME_LIST =  listOf<String>(Constants.ADD_CHILD,Constants.FIND_CENTER,Constants.CURRICULAM,Constants.PRACTICE_MATH,Constants.MY_PROFILE)
        var HOME_ITEM_IMAGE_LIST = listOf<Int>(R.drawable.ic_add_child,R.drawable.ic_location_pin,R.drawable.ic_curriculum,R.drawable.ic_practice_math,R.drawable.ic_custom_person)
